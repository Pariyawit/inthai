			...
			<div class="card-body">
				...
				<form class="create-order-form" @submit.prevent="onSubmit">
					<div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <ValidationProvider rules="required" v-slot="{ errors }">
                                <input id="name" type="text" class="form-control" v-model="name" name="name" value="" autocomplete="name" autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <ValidationProvider rules="required|numeric|min:10" v-slot="{ errors }">
                                <input id="mobile" type="tel" class="form-control" v-model="mobile" name="mobile" value="" autocomplete="mobile" placeholder="">
                                <span class="error">{{ errors[0] }}</span>
                            </ValidationProvider>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <ValidationProvider rules="required" v-slot="{ errors }">
                                <input id="address" type="text" class="form-control" v-model="address" name="address" value="" autocomplete="address">
                                <span class="error">{{ errors[0] }}</span>
                            </ValidationProvider>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <ValidationProvider rules="" v-slot="{ errors }">
                                <input id="address2" type="text" class="form-control" v-model="address2" name="address2" value="" autocomplete="address2">
                                <span class="error">{{ errors[0] }}</span>
                            </ValidationProvider>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <ValidationProvider rules="required" v-slot="{ errors }">
                                <input id="suburb" type="text" class="form-control" v-model="suburb" name="suburb" value="" autocomplete="suburb">
                                <span class="error">{{ errors[0] }}</span>
                            </ValidationProvider>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <ValidationProvider rules="required" v-slot="{ errors }">
                                <input id="state" type="text" class="form-control" v-model="state" name="state" value="" autocomplete="state">
                                <span class="error">{{ errors[0] }}</span>
                            </ValidationProvider>
                        </div>
                    </div>
					<div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <ValidationProvider rules="required|numeric" v-slot="{ errors }">
                                <input id="postcode" type="text" class="form-control" v-model="postcode" name="postcode" value="" autocomplete="postcode">
                                <span class="error">{{ errors[0] }}</span>
                            </ValidationProvider>
                        </div>
                    </div>
